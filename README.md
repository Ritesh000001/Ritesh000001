<h1 align="center">Hi, I'm Ritesh Singh Kushwaha 👋</h1>
<h3 align="center">Software Developer | Full Stack Developer (MERN) | Building production-ready full-stack applications</h3>

<p align="center">
  🌱 MCA (LPU, CGPA 8.3) &nbsp;|&nbsp; 📍 Noida, India &nbsp;|&nbsp; 🎯 Open to SDE / Full-Stack Developer roles
</p>

---

### 🚀 About Me
- 💻 I build full-stack web & mobile applications using **React.js, Node.js, Express.js, and MongoDB**
- 🔐 Interested in secure, real-world systems — authentication, fraud detection, and product verification
- 🛠️ Also comfortable with **Firebase**, **Kotlin (Android)**, and integrating AI/LLM APIs into products
- 📚 Completed a MERN-stack internship at Blue Planet Info Solution Pvt. Ltd., shipping production modules
- 📫 Reach me: [LinkedIn](https://linkedin.com/in/ritesh-singh-kushwaha) 
